...
json_spirit::mValue doTransitionTest(json_spirit::mValue const& _v_orig, bool _fillin)
{
	json_spirit::mValue output = _v_orig;
...
json_spirit::mValue doBlockchainTestNoLog(json_spirit::mValue const& _v_orig, bool _fillin)
{
	json_spirit::mValue v = _v_orig; // TODO: avoid copying and add only valid fields to the new object.
