...
//do*Tests(_v, _fillin) always return a filled test.
//When _fillin is true, _v is supposed to contain a filler.  Otherwise, _v is also a filled test.
json_spirit::mValue doTransactionTests(json_spirit::mValue const& _v, bool _fillin);
json_spirit::mValue doStateTests(json_spirit::mValue const& v, bool _fillin);
json_spirit::mValue doVMTests(json_spirit::mValue const& v, bool _fillin);
json_spirit::mValue doBlockchainTests(json_spirit::mValue const& _v, bool _fillin);
json_spirit::mValue doBlockchainTestNoLog(json_spirit::mValue const& _v, bool _fillin);
json_spirit::mValue doTransitionTest(json_spirit::mValue const& _v, bool _fillin);
